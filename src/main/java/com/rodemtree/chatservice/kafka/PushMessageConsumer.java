...
import com.rodemtree.chatservice.dto.kafka.inbound.RecordInterface;
...
public class PushMessageConsumer {
    ...
    public void consumeMessage(ConsumerRecord<String, String> consumerRecord, Acknowledgment ack) {
        try {
